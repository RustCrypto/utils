...
mod stack_sanitization_tests {
    use zeroize::{create_aligned_vec, secure_crypto_call, secure_crypto_call_heap};
    ...
    fn return_safety_and_zeroization_of_temp_data() {
        // results in segmentation fault
        let result = unsafe { secure_crypto_call(|| dummy_fn()) };
